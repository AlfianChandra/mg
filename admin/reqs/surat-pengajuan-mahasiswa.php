<?php 
  ...
  if(!$_POST)
  {
    ...
    $_SESSION['nim_pengajuan'] = $_POST['id'];      
  }
 ?>
...
<form action='../action/uploadPengajuan.php' method='post' enctype='multipart/form-data'>
  ...
  <div class="col-md-12">
    <h4 style='font-weight: bold;'>Pilih Dokumen Surat Pengajuan Magang</h4>
    <div class="input-area">
      <input type="file" required="required" accept=".pdf" name="pengajuan" class='inputs1'>
      <h5 class='h51'><i class='material-icons'>file_upload</i> <br> Dokumen Surat Pengajuan Magang<br> (Seret File / Klik Area Ini)</h5>
    </div>
  </div>
