      ...
      <tbody>
        <?php 
            foreach ($instansi->datas as $key) {
              echo "<tr style='text-transform:capitalize' class='clicker' data-id='$key->username'><td>".$key->nama_instansi."</td><td>".$key->kapasitas."</td><td>".$key->pemagang_diterima."</td><td>".$key->pemagang_terdaftar."</td></tr>";
            }
         ?>
      </tbody>
  </table>
